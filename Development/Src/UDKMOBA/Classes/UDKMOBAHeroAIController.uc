...
// The hotkeys for the character's spells
var(Hotkeys) array<string> Hotkeys;
...
function Tick(float DeltaTime)
{
	...
	// Handle spell casts along with the hotkeys for the spells
	//if (PlayerInput.PressedKeys.Find(Hotkeys[0]))
	//{
	//	UDKMOBAPlayerController.CastSpell(0);
	//}
}
